export const translations = {
  de: {
    ...
    hero: {
      ...
      title1: "PRECISION",
      title2: "IN MOTION.",
      subtitle: "Kundenorientierter Steuerungs- und Anlagenbau für die moderne Industrie. Wir vereinen über 30 Jahre Erfahrung mit der Technik von morgen.",
    ...
    services: {
      ...
      subtitle: "Professionelle Lösungen für Steuerung, Anlagenbau und spezialisierte Maschinenkomponenten.",
    ...
    about: {
      ...
      cards: [
        ...
        { title: "Qualität & Sicherheit", text: "Höchste Qualitätsstandards durch persönliche Abnahme und Prüfung nach VDE-Vorschriften. Umfassende Dokumentation und Zertifizierung aller Arbeiten." },
      ],
    },
    partners: {
      label: "Netzwerk",
  ...
  en: {
    ...
    hero: {
      ...
      title1: "PRECISION",
      title2: "IN MOTION.",
      subtitle: "Customer-oriented control and plant engineering for the modern industry. We combine over 30 years of experience with tomorrow's technology.",
    ...
    services: {
      label: "Competencies",
      title: "OUR SERVICES",
      subtitle: "Professional solutions for control systems, plant engineering and specialized machine components.",
    ...
    about: {
      ...
      p1: "Reliability, expertise and customized solutions for over 25 years.",
      p1b: "Our entrepreneurial principles are consistently oriented towards the requirements and goals of our customers. On this basis, we create the conditions for joint, sustainable success.",
      p2: "Many years of experience combined with innovative planning offer our customers a high degree of investment security. Quality in production, adherence to deadlines and a reasonable price-performance ratio are at the center of our actions.",
      p3: "Standard solutions are not part of our self-image. Instead, we develop individual concepts tailored to the specific requirements of your application. Within our broad range of services, we have well-founded specializations in various specialist areas. All projects are personally inspected by a master craftsman with over 25 years of professional experience and accepted in accordance with the applicable VDE regulations.",
      cards: [
        ...
        { title: "Quality & Safety", text: "Highest quality standards through personal acceptance and inspection according to VDE regulations. Comprehensive documentation and certification of all work." },
      ],
    },
    partners: {
      label: "Network",
