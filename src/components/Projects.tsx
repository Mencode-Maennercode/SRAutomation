        ...
        {selected !== null && sel && selT && (
          ...
          >
            <button
              ...
              className="fixed top-20 right-4 md:top-24 md:right-6 z-50 w-11 h-11 glass rounded-full flex items-center justify-center hover:bg-white/20 transition-colors shadow-lg"
            >
              <X className="w-5 h-5" />
            </button>
